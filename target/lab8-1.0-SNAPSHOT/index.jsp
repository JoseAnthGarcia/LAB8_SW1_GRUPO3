...
<div class='container'>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><a href="<%=request.getContextPath()%>/SeleccionesServlet?action=editar&idSeleccion=<%=seleccion.getIdSeleccionesNacionales()%>">Editar</a></td>
            <td><a href="<%=request.getContextPath()%>/SeleccionesServlet?action=borrar&idSeleccion=<%=seleccion.getIdSeleccionesNacionales()%>">Borrar</a></td>
        </tr>
        <%
                i++;
            }
